...
#
#
# def test_build_archive_not_existing(pops):
#         pops = [pops[4], pops[0]]
#         for pop in pops:
#
#             self.assertRaises(
...
#             self.pop_5, len(self.pop_5) + 1, self.correct_sort_key
#         )
...
#         archive = arch.build_archive(
#             self.pop_5, len(self.pop_5), self.correct_sort_key
#         )
#         if len(archive) != len(self.pop_5):
#             self.fail("Incorrect archive size")
#         for x in range(1, 6):
...
#             self.pop_5,
#             -1,
#             self.correct_sort_key,
#         )
#
#     def test_build_archive_pop1_arch_size_gt_pop(self):
#         archive = arch.build_archive(
#             self.pop_1, len(self.pop_1) + 1, self.correct_sort_key
#         )
...
#         archive = arch.build_archive(
#             self.pop_1, len(self.pop_1), self.correct_sort_key
#         )
#         if len(archive) != len(self.pop_1):
#             self.fail("Incorrect archive size")
#         if "1" not in archive:
...
#             actual, pop, desired_size, self.correct_sort_key
#         )
#         self.assertEqual(
#             expected, actual, "Partial-Did not result in the same dict"
#         )
...
#         )
#         self.assertEqual(
#             expected, actual, "Empty-Did not result in the same dict"
#         )
#
...
#         self.assertEqual(
#             expected, actual, "Can not truncate archive down to 0"
#         )
#         actual = copy.deepcopy(self.pop_6)
#         desired_size = 4
#         expected = {
...
#         arch.truncate_archive(actual, desired_size, self.correct_sort_key)
#         self.assertEqual(
#             expected, actual, "Can not truncate archive down to regular case"
#         )
#
